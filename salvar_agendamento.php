...
if (!isset($_SESSION['usuario']['id'])) {
    // Guarda a página para redirecionar depois do login
    $_SESSION['redirect_depois_login'] = 'salvar_agendamento.php';
...
if (mysqli_num_rows($check) > 0) {
    ...
    $insert = mysqli_query($conn, "
        ...
        VALUES ($id_profissional, $id_servico, '$data', '$hora', '$hora_fim', $usuario_id)
    ");
    if ($insert) {
