...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Inserção simples
  mysqli_query($conn, "INSERT INTO usuarios (nome, email, senha , telefone) VALUES ('$nome', '$email', '$senha', '$telefone')");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="cadastro_usuario.php" class="nav-item nav-link active">Cadastre-se</a>
